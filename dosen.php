                ...
                <main>
                    <div class="container-fluid px-4">
                        ...
                        <div class="card mb-4">
                            ...
                            <div class="col-4-md">
                            <a href="tambah/tambah_dosen.php" class="btn btn-success mt-3">Tambah Data Dosen</a>
                            </div>
                            <div class="card-body">
						    ...
						    ?>
                                        <tr>
                                            ...
                                            <td>
                                            <a href="edit/edit_dosen.php?id_dosen=<?php echo $row['id_dosen']  ?>" class="btn btn-success btn-sm btn-block">EDIT</a>
                                            <a href="hapus/proses_hapus.php?id_dosen=<?php echo $row['id_dosen']  ?>" class="btn btn-danger btn-sm btn-block text-light">HAPUS</a>  
							                </td>
                                        </tr>
                                        <?php }}else{ ?>
							<tr>
