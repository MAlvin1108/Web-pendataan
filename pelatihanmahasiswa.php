                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                <table id="datatablesSimple">
                                    ...
                                    <?php
							$no = 1;
							$mahasiswa = mysqli_query($koneksi, "SELECT mahasiswa.nim, mahasiswa.nama, bisnis.id_bisnis, bisnis.nama_bisnis, bisnis.ket,
                            pelatihan.id_pelatihan, pelatihan.nama_pelatihan, pelatihan.kategori, pelatihan.jadwal, pelatihan.id_dosen
                            FROM mahasiswa INNER JOIN bisnis ON mahasiswa.id_bisnis=bisnis.id_bisnis INNER JOIN pelatihan ON mahasiswa.id_pelatihan=pelatihan.id_pelatihan 
