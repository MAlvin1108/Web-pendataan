                ...
                <main>
                    <div class="container-fluid px-4">
                        ...
                        <div class="card mb-4">
                            ...
                            <div class="col-4-md">
                            <a href="tambah/tambah_bisnis.php" class="btn btn-success mt-3">Tambah Data Bisnis</a>
                            </div>
                            <div class="card-body">
                                <table id="datatablesSimple">
                                    ...
                                    <?php
							$no = 1;
							$bisnis = mysqli_query($koneksi, "SELECT * FROM bisnis");
							if(mysqli_num_rows($bisnis) > 0){
							while($row = mysqli_fetch_assoc($bisnis)){
						    ?>
                                        <tr>
                                            <td><?php echo $no++ ?></td>
                                            ...
                                            <td>
                                            <a href="edit/edit_bisnis.php?id_bisnis=<?php echo $row['id_bisnis']  ?>" class="btn btn-success btn-sm btn-block">EDIT</a>
                                            <a href="hapus/proses_hapus.php?id_bisnis=<?php echo $row['id_bisnis']  ?>" class="btn btn-danger btn-sm btn-block text-light">HAPUS</a>  
							                </td>
                                        </tr>
                                        <?php }}else{ ?>
							<tr>
