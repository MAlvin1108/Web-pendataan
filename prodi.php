                ...
                <main>
                    <div class="container-fluid px-4">
                        ...
                        <div class="card mb-4">
                            ...
                            <div class="col-4-md">
                            <a href="tambah/tambah_prodi.php" class="btn btn-success mt-3">Tambah data prodi</a>
                            </div>
                            <div class="card-body">
						    ...
						    ?>
                                        <tr>
                                            ...
                                            <td>
                                            <a href="edit/edit_prodi.php?id_prodi=<?php echo $row['id_prodi']  ?>" class="btn btn-success btn-sm btn-block">EDIT</a>
                                            <a href="hapus/proses_hapus.php?id_prodi=<?php echo $row['id_prodi']  ?>" class="btn btn-danger btn-sm btn-block text-light">HAPUS</a>  
							                </td>
                                        </tr>
                                        <?php }}else{ ?>
							<tr>
