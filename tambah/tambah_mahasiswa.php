...
<html lang="en">
 ...
 <!-- Form  -->
  <div class="container">
    <h3 class="text-center mt-3 mb-5">Tambah Data Mahasiswa</h3>
  ...
  if(isset($_POST['tambah'])){
    ...
    $insert = mysqli_query($koneksi, "INSERT INTO mahasiswa VALUES ($nim, '$nama', '$alamat', '$no_hp', '$id_bisnis', '$id_prodi', '$id_pelatihan')");
