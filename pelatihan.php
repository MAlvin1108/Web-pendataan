                ...
                <main>
                    <div class="container-fluid px-4">
                        ...
                        <div class="card mb-4">
                            ...
                            <div class="col-4-md">
                            <a href="tambah/tambah_Pelatihan.php" class="btn btn-success mt-3">Tambah Data Pelatihan</a>
                            </div>
                            <div class="card-body">
                                <table id="datatablesSimple">
                                    ...
                                    <?php
							$no = 1;
							$pelatihan = mysqli_query($koneksi, "SELECT * FROM pelatihan LEFT JOIN dosen USING (id_dosen) 
                            ORDER BY id_pelatihan DESC");
							if(mysqli_num_rows($pelatihan) > 0){
							while($row = mysqli_fetch_assoc($pelatihan)){
						    ?>
                                        <tr>
                                            <td><?php echo $no++ ?></td>
                                            ...
                                            <td>
                                            <a href="edit/edit_pelatihan.php?id_pelatihan=<?php echo $row['id_pelatihan']  ?>" class="btn btn-success btn-sm btn-block">EDIT</a>
                                            <a href="hapus/proses_hapus.php?id_pelatihan=<?php echo $row['id_pelatihan']  ?>" class="btn btn-danger btn-sm btn-block text-light">HAPUS</a>  
							                </td>
                                        </tr>
                                        <?php }}else{ ?>
							<tr>
