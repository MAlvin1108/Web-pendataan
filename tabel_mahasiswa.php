                ...
                <main>
                    <div class="container-fluid px-4">
                        ...
                        <div class="card mb-4">
                            ...
                            <div class="col-4-md">
                            <a href="tambah/tambah_mahasiswa.php" class="btn btn-success mt-3">Tambah data mahasiswa</a>
                            </div>
                            <div class="card-body">
                                <table id="datatablesSimple">
                                    ...
                                    <?php
							$no = 1;
							$mahasiswa = mysqli_query($koneksi, "SELECT * FROM mahasiswa LEFT JOIN prodi USING (id_prodi) LEFT JOIN bisnis USING (id_bisnis) 
                            LEFT JOIN pelatihan USING (id_pelatihan)
                            ORDER BY nim DESC");
						    ...
						    ?>
                                        <tr>
                                            ...
                                            <td>
                                            <a href="edit/edit_mahasiswa.php?nim=<?php echo $row['nim']  ?>" class="btn btn-success btn-sm btn-block">EDIT</a>
                                            <a href="hapus/proses_hapus.php?nim=<?php echo $row['nim']  ?>" class="btn btn-danger btn-sm btn-block text-light">HAPUS</a>  
							                </td>
                                        </tr>
                                        <?php }}else{ ?>
							<tr>
